...
public final class SimilarUserAlt extends SimilarUser {
  
  public SimilarUserAlt(long userID, double similarity) {
    super(userID, similarity);
  }
  
  /**
   * Defines an ordering from most similar to least similar.
   * For equally similar users, higher IDs are chose first.
   */
  @Override
