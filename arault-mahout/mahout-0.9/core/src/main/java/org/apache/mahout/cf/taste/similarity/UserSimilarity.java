...
/**
 * <p>
 * Implementations of this interface define a notion of similarity between two
 * users. Implementations should return values in the range -1.0 to 1.0, with
 * 1.0 representing perfect similarity.
 * </p>
 * 
 * @see ItemSimilarity
 */
public interface UserSimilarity extends Refreshable {
	...
	/**
	 * <p>
	 * Attaches a {@link PreferenceInferrer} to the {@link UserSimilarity}
	 * implementation.
	 * </p>
	 * 
	 * @param inferrer
