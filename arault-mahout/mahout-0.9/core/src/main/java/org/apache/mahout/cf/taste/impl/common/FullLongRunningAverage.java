 ...
 * </p>
 */
public class FullLongRunningAverage implements LongRunningAverage, Serializable {
  
  private long count;
  private double average;
  
  public FullLongRunningAverage() {
    this(0, Double.NaN);
  }

  public FullLongRunningAverage(long count, double average) {
    this.count = count;
