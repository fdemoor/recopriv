 ...
 * wasn't added. This is similar to RunningAverage but can keep track of the running average of bigger series 
 * of numbers though use of a long counter (instead of an int counter).
 * </p>
 */
public interface LongRunningAverage {
  ...
  // Would requires to implement a long version of InvertedRunningAverage
  /**
