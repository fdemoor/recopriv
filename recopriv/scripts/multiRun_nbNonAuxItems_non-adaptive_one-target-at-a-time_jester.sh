...
##################################################################################################
# Precomputation part of the Non-adaptive Sybil attack, one target attacked at a time, on jester #
##################################################################################################
...
expeDir="jester/non-adaptive/one_target_at_a_time/precomputations/"
mkdir -p $expeDir
cd $expeDir
