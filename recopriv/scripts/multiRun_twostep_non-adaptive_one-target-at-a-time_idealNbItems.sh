...
##############################################################################################################################
# Non-adaptive Sybil attack, one target attacked at a time, with twostep and twostepglobal measures and varying idealNbItems #
##############################################################################################################################
...
for twostepIdealNbItems in 25 50 100 200 400 500; do 
   for similarityType in "twostep(0.8)" "twostepglobal(0.8)"; do
	dir="${similarityType}/idealNbItems${twostepIdealNbItems}/one_target_at_a_time"
	mkdir -p $dir
	cd $dir
