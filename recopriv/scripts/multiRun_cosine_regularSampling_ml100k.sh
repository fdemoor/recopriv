...
auxiliaryItemsSelectionStrategy=regularSampling
#nbSybils=10
...
expeDir="ml100k/${auxiliaryItemsSelectionStrategy}/${similarityType}"
mkdir -p $expeDir
cd $expeDir
...
for targetID in 700 924 319 662 553 800 737 322 39 519 391 378 185 878 592 376 817 344 318 821 133 639 707 389 900 569 323 759 363 467 131 255 770 644 552 726 144 216 771 388 345 692 686 231 457 674 129 755 222 874; do
