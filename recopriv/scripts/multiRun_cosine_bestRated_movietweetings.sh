...
##################################################################################
# Non-adaptive Sybil attack, random auxiliary information, with cosine on movietweetings #
##################################################################################
...
expeDir="movietweetings/${auxiliaryItemsSelectionStrategy}/${similarityType}"
mkdir -p $expeDir
cd $expeDir
