...
#################################################################################################
# Non-adaptive Sybil attack, one target attacked at a time, with twostepglobal80 varying idealNbItems #
#################################################################################################
...
expeDir="jester/non-adaptive/one_target_at_a_time/${similarityType}/"
mkdir -p $expeDir
cd $expeDir

for targetID in $(seq 1 24983); do
	for twostepIdealNbItems in 10 25 50 75 90; do 
